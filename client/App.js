  ...
  constructor(props) {
    ...
    this.state = {
      ...
      user: {
        userid: "",
        avatar:
          "https://www.secondcity.com/wp-content/uploads/2018/11/Eric-Stallings.jpg",
        userName: "",
...
*/
    ...
    this.populateGameDisplayHandler = this.populateGameDisplayHandler.bind(
      this
    );
...
*/
  ...
  addGameToUserHandler(game) {
    this.setState({
      ...
      user: {
        ...this.state.user,
        gamesPlaying: [...this.state.user.gamesPlaying, game]
      },
      games
    });
  }
      ...
      <ThemeProvider theme={theme}>
        <Route
          ...
          render={() => (
            <Dashboard
              {...this.state}
              populateSideBarHandler={this.populateSideBarHandler}
            />
          )}
        />
        <Route
